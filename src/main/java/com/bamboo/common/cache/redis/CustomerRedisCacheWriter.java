...
public class CustomerRedisCacheWriter implements RedisCacheWriter {
    ...
    public void put(String name, byte[] key, byte[] value, @Nullable Duration ttl) {
        ...
        this.execute(name, (connection) -> {
            ...
            logger.info("put: name ={} , key ={} , value ={} , ttl ={}", name , keyStr ,new String ( value, Charset.forName("UTF-8") ), ttl);
            if (index  > 0){
                ...
                logger.info("put: name ={} , key ={} , expireString ={} , ttl ={}", name , keyStr ,expireString, expireTime);
    ...
    public byte[] get(String name, byte[] key) {
        ...
        return (byte[])this.execute(name, (connection) -> {
            String keyStr =new String ( key, Charset.forName("UTF-8") );
            int index = keyStr.lastIndexOf(TTL);
            logger.info("get: name ={} , key ={} ", name , keyStr);
            if (index  > 0) {
                keyStr = keyStr.substring(0, index);
                logger.info("get: name ={} , key ={} ", name , keyStr);
