...
//    @Lazy(false)
    public static class  IdGenerate   {
    	 ...
    	 * 使用时间戳随机生成Long. 
    	 */
    	public static long randomTimeLong() {
    		return Math.abs(Long.valueOf(System.currentTimeMillis()+""+random.nextInt(100000)));
    	}

    	/**
    	 * 基于Base62编码的SecureRandom随机生成验证码字符串.
    	 */
    	...
    	public static void main(String[] args) {
    		...
    		System.out.println(new IdGenerate().getNextId());
    		for (int i=0; i<1000; i++){
    			System.out.println(IdGenerate.randomTimeLong() + "  " + IdGenerate.randomBase62(5));
    		}
    	}
    ...
    /****
	 * 将<Map<String, Object>>类型的列表中的key值由下划线类型改成驼峰风格的key
	 * 
	 * @param mapList
	 *            <Map<String, Object>>类型的列表
	 * @return
	 */
	public static List<Map<String, Object>> mapListKey2CamelKey(List<Map<String, Object>> mapList) {
		List<Map<String, Object>> retList = new ArrayList<Map<String, Object>>();
		for (Map<String, Object> map : mapList) {
			Map<String, Object> obj = mapKey2CamelKey(map);
			retList.add(obj);
		}
		return retList;
	}
	...
	/****
	 * 将Map<String, Object>类型的列表中的key值由下划线类型改成驼峰风格的key
	 * 
	 * @param map
	 *            map<String, Object>型的列表
	 * @return
	 */
	public static Map<String, Object> mapKey2CamelKey(Map<String, Object> map) {
	
		Map<String, Object> obj = new HashMap<>();
		for (Map.Entry<String, Object> entry : map.entrySet()) {
			String key = toCamelCase(entry.getKey());// 下划线参数改成驼峰参数类型
